                        ...
                        docRef.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                            ...
                            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    Long l = new  Long(0);
                                    l = (long)document.get("price");
                                    Double a = (double)l;



                                    Item nItem = new Item(document.get("name").toString(), document.get("desc").toString(), document.get("picture").toString(), document.get("seller_netid").toString(), document.get("condition").toString(), document.get("location_key").toString(), (boolean)document.get("status"), a);
                                    itemList.add(nItem);
                                    iAdapter.notifyDataSetChanged();
                                } else {
